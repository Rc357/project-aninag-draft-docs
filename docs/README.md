# Project Obserba — Documentation Suite

Project Obserba is a cloud-native **Local Government Operations Platform** for the Philippines. It launches with a single module — **Citizen Incident Reporting** — built on an architecture designed from day one to scale into a full multi-tenant operating system for cities, municipalities, and eventually provincial and national government agencies.
...
Per the source brief's [Documentation Strategy](../initial-project-obserba.md), the following were deferred until UI/UX and codebase decisions exist to document against — request them individually when ready:
...
All documents trace back to the original founding brief: [`initial-project-obserba.md`](../initial-project-obserba.md).
